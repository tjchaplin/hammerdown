...
DocumentStream.prototype.appendWithPrefix = function(prefix,data){
	var self = this;

	var previousAtNewLine = self.atNewline;
	var atDocumentStart = self.atDocumentStart;
	...
	if(doesntStartWithNewline && (previousAtNewLine || atDocumentStart))
		data = prefix+data;
