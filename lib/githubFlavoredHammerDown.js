...
GithubFlavoredHammerDown.prototype.codeOpen = function(language) {
	this.writerState.inCode();
	if(!language)
		language = '';

	if(this.writerState.isInBlockCode())
		this.documentStream.append('```'+language+'\n');
	else
		this.documentStream.append('`');
	return this;
};

GithubFlavoredHammerDown.prototype.codeClose = function() {
...
GithubFlavoredHammerDown.prototype.prefixWithBlockCode = function(data){
	...
	if(this.writerState.isInCode())
		return this.documentStream.appendFormatted(data);
...
GithubFlavoredHammerDown.prototype.tableOpen = function(){
	this.documentStream.appendFormatted('\n\n');
	return this;
};
GithubFlavoredHammerDown.prototype.tableClose = function(){
	this.documentStream.appendFormatted('\n\n');
	return this;
};
